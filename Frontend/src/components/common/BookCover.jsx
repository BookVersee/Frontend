...
export const BookCover = ({
  ...
  return (
    <div
      className={`${dims[size] || dims.md} rounded-xl flex flex-col justify-end p-3 shrink-0 shadow-sm relative overflow-hidden transition-transform group-hover:scale-[1.02] ${className}`}
      style={{
